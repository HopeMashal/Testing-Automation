...
public class TrelloTask {
  ...
  public void trelloTest() throws Exception{
    ...
    TakeScreenShot takeSc = new TakeScreenShot(driver);
		takeSc.takeScreenShot("downloads/"+TrelloTask.Browser+"BeforeCardCreation.jpg");
    Thread.sleep(2000);
    boardPage.CreateCard(Card1Name);
    Thread.sleep(2000);
    takeSc.takeScreenShot("downloads/"+TrelloTask.Browser+"AfterCardCreation.jpg");
    Thread.sleep(2000);
    boardPage.EditDescription(Card1Description);
    Thread.sleep(2000);
    takeSc.takeScreenShot("downloads/"+TrelloTask.Browser+"BeforeAttachFile.jpg");
    Thread.sleep(2000);
