...
public class BoardPage {
  ...
  public void CreateCard(String titleCard) {
    createBox =
      driver.findElement(
        By.xpath("//*[@id='board']/div[1]/div/div[2]/div/div[1]/div/textarea")
      );
    createBox.sendKeys(titleCard);
    addBtn =
      driver.findElement(
        By.xpath("//*[@id='board']/div[1]/div/div[2]/div/div[2]/div[1]/input")
      );
    addBtn.click();
  }
  ...
  public void CreateNewCard(String titleCard) {
    createCard =
      driver.findElement(By.xpath("//*[@id='board']/div[1]/div/div[3]/a"));
    createCard.click();
    createBox =
      driver.findElement(
        By.xpath("//*[@id='board']/div[1]/div/div[2]/div/div[1]/div/textarea")
  ...
  public void CreateCardUsingActions() throws InterruptedException {
    cardElement =
      driver.findElement(
        By.xpath("//*[@id='board']/div[1]/div/div[2]/a[1]/div[3]")
      );
    cardElement.click();
    ...
    titleBox =
      driver.findElement(
        By.xpath(
          "//*[@id='chrome-container']/div[3]/div/div/div/div[3]/div[1]/textarea"
        )
      );
    ...
    closeBtn =
      driver.findElement(
        By.xpath("//*[@id='chrome-container']/div[3]/div/div/a")
      );
    closeBtn.click();
    Thread.sleep(2000);
    createCard =
  ...
  public void EditDescription(String description) throws InterruptedException {
    cardElement =
      driver.findElement(
        By.xpath("//*[@id='board']/div[1]/div/div[2]/a/div[3]")
      );
    cardElement.click();
    Thread.sleep(2000);
    descriptionBox =
      driver.findElement(
        By.xpath(
          "//*[@id='chrome-container']/div[3]/div/div/div/div[4]/div[2]/div/div/div/div[2]/div/div/div[3]/textarea"
        )
      );
    ...
    saveBtn =
      driver.findElement(
        By.xpath(
          "//*[@id='chrome-container']/div[3]/div/div/div/div[4]/div[2]/div/div/div/div[2]/div/div/div[3]/div/input[1]"
        )
      );
    saveBtn.click();
  }
  ...
  public void DownloadFile() throws InterruptedException {
    downloadFile =
      driver.findElement(
        By.xpath(
          "//*[@id='chrome-container']/div[3]/div/div/div/div[4]/div[9]/div[2]/div/div/p/a"
        )
      );
    downloadFile.click();
    Thread.sleep(2000);
  ...
  public void CheckFiles(String CSVPath, String CSVDownloadPath)
    throws Exception {
    ...
    for (int i = 0; i < CSVFileLines.size(); i++) {
      ...
      for (int j = 0; j < strList.length; j++) {
        Assert.assertEquals(
          CSVFileLines.get(i)[j],
          downloadLines.get(i)[j],
          "Two files NOT Match !!!"
        );
      }
    }
  ...
  public void CheckCard(String CardName) {
    Cards =
      driver.findElements(
        By.xpath("//*[@id='board']/div[1]/div/div[2]/a/div[3]/span")
      );
  ...
  public void DeleteCard() throws InterruptedException {
    ...
    archiveBtn =
      driver.findElement(
        By.xpath(
          "//*[@id='chrome-container']/div[3]/div/div/div/div[5]/div[5]/div/a[5]"
        )
      );
    archiveBtn.click();
    Thread.sleep(2000);
  ...
  public void DeleteBoard() throws InterruptedException {
    showMenuBtn =
      driver.findElement(
        By.xpath(
          "//*[@id='content']/div/div[1]/div[1]/div[5]/span[9]/div/button"
        )
      );
    showMenuBtn.click();
    Thread.sleep(2000);
    MoreBtn =
      driver.findElement(
        By.xpath(
          "//*[@id='content']/div/div[2]/div/div/div[2]/div/ul[1]/li[5]/a"
        )
      );
    MoreBtn.click();
    Thread.sleep(2000);
    closeBoardBtn =
      driver.findElement(
        By.xpath("//*[@id='content']/div/div[2]/div/div/div[2]/div/ul[3]/li/a")
      );
    closeBoardBtn.click();
    Thread.sleep(2000);
    closeBBtn =
      driver.findElement(
        By.xpath(
          "//*[@id='chrome-container']/div[4]/div/div[2]/div/div/div/input"
        )
      );
    closeBBtn.click();
  }
