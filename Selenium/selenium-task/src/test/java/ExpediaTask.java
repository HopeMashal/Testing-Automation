...
public class ExpediaTask {
  ...
  public void testDataCSV(String Id, String Name, String City, String Address)
    ...
    for (WebElement result : results) {
      ...
      if (
        URL.contains("https://www.expedia.com/") &&
        URL.contains(".Hotel-Information")
      ) {
        URLList.add(URL);
        counter += 1;
      }
